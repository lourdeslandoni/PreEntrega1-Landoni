      ...
      <div className="storeCardContainer">
        ...
        <CardContent sx={{width: "100%",
            ...
            <div className="containerDetails">
              <Link to={`/item/${product.id}`} className="detailButton"><Button sx={{color: "#FFE1E1", ":hover": {
        backgroundColor: '#FFB9B9'} }} color="primary" variant="contained">Ver Detalles</Button></Link>
          </div>
        </CardContent>
        </Card> 
