...
export default function Carrito() {
    ...
    return(
        <div className='cartContainer'>
            ...
            <Table sx={{ minWidth: 300, backgroundColor: "#FFB9B9"}} aria-label="simple table">
                <TableHead>
                <TableRow>
                ...
                {cart.map((row) => (
                    ...
                    <TableCell sx={properties} component="th" scope="row">
                        ...
                        &nbsp;
                        &nbsp;
                        <Button onClick={() => deleteCartItem(row.id)} sx={{ fontWeight: "600", backgroundColor: "whitesmoke" ,color: "#FFE1E1", ":hover": {
            ...
            <Link to={'/checkout'} style={{textDecorationLine: "none"}}>
                <Button onClick={() => updateAmounts(totalPrice, totalAmount)} sx={{  height:"50px",fontWeight: "600", backgroundColor: "whitesmoke" ,color: "#FFE1E1", ":hover": {
