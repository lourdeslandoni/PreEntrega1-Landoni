...
export default function Counter({stock, initial, item}) {
  ...
  return (
    ...
    <div style={{ width: "450px", display: "flex", alignItems: "center", justifyContent: "space-between", padding: 30, backgroundColor: 'white', margin: "0 50px" ,borderRadius: "0 0 30px 30px"}}>
